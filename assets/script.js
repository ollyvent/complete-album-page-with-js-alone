...
imgEl.setAttribute('style', 'display:flex; width:400px; border:solid 5px gold; margin-right:10px') // add width and border-gold to img
...
divContent.setAttribute('style', 'width:50%; align-items:center; justify-content:left; border-left:solid 2px wheat; padding-left:10px'); //  the album content styling
